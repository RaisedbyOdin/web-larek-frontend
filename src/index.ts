...
// отслеживание событий, для дальнейшей проработки
...
// рендер и сохранение в модели данных для карт товара
...
// установка данных о добавленном в корзину
...
// рендер модального окна с заказом
...
// рендер модального окна с контактами
...
// обработка изменения поля для ввода контактов
events.on(
	/^contacts\..*:change/,
...
// остановка прокрутки при открытии 
events.on('modal:open', () => {
	page.locked = true;
});

// продолжение прокрутки при закрытии 
